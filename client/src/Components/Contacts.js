...
export default function Contacts() {
  ...
  return (
    <div className="body-container">
      ...
      <main className="home-body" id="contact-main">
        {isAdmin && (
          <div className="form-admin" id="admin-contact">
        ...
        <div id="contact-body">
          <div className="contact-sec">
            ...
            <section className="contact">
              ...
              <p>
                @: info@pawsitivity.com <br></br>
                ☎︎ 031212322 / 347 111239<br></br>
              </p>
              <p>
                Wonder Woof s.r.l.<br></br>
                Via A. Manzoni, 15<br></br>
                22100 Como<br></br>
              </p>
            </section>
          </div>{" "}
          <img id="contact-img" src="imgs/bbdogs.jpg" alt="dogs" />
        </div>
      </main>
